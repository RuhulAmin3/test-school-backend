export const emailVerificationTemplate = (otp: string): string => {
  return `
    <!DOCTYPE html>
          ...
          <tr>
            <td style="padding:30px;text-align:left;color:#374151;">
              ...
              <p style="font-size:15px;line-height:1.5;margin-bottom:24px;">
                Thank you for registering with <strong>Test_School</strong>!  
                Please use the verification code below to complete your sign-up process.  
                This code will expire in <strong>05 minutes</strong>.
              </p>
